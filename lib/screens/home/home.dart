  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      endDrawer: ConstrainedBox(
        // ConstrainedBox: mettre à l'enfant des contraintes supplementaire comme : max..., min...
        constraints: BoxConstraints(maxWidth: 300),
        child: SideMenu(),
      ),
      body: SingleChildScrollView(
        // SingleChildScrollView: fait defiler l'unique widget si le conteneur devient trop petit (lors retrecissement)
        child: SafeArea(
          // SafeArea: éviter les intrusions du système d'exploitation (encoche.. des smartphones)
          child: Container(
            width: size.width,
